...
* [Pastely.eu](https://pastely.eu) - GDPR-first all-in-one service — Link-in-Bio, link shortener, and digital business cards (vCards). EU-hosted, fair pricing, free plan available.
...
* [kutt.it](https://github.com/thedevs-network/kutt) - Self-hosted option
...
* [rip.to](https://rip.to)
* [s2r.co](https://s2r.co)
* [san.aq](https://san.aq) - (usable with `curl`) - invalid cert
* [soo.gd](https://soo.gd/)
